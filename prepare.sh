...
CUDA_VISIBLE_DEVICES=0,1,2,3 ./tools/dist_train.sh  configs/lvis/detpro_ens_20e.py 4 --work-dir workdirs/collect_data --cfg-options model.roi_head.load_feature=False total_epochs=1
...
CUDA_VISIBLE_DEVICES=0,1,2,3 ./tools/dist_train.sh  configs/lvis/prompt_save_train_reuse.py 4 --work-dir workdirs/prompt_save_train
CUDA_VISIBLE_DEVICES=0,1,2,3 ./tools/dist_train.sh  configs/lvis/prompt_save_val.py 4 --work-dir workdirs/prompt_save_val
